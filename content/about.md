...
​	So this is just one big page where I can write all about myself, without feeling the need for it to be [useful](https://sivers.org/useless). And some day this site will be all that’s left of me, so I might as well write my own mini autobiography.

## 	Time line for context:

- ​	1969: born in California
- ​	1976: started playing piano, viola, and clarinet
- ​	1979: got a [TRS-80](https://en.wikipedia.org/wiki/TRS-80) computer and dove deep into programming in [BASIC](https://en.wikipedia.org/wiki/BASIC)
...
- ​	1992: quit my job, and toured Japan as [Ryuichi Sakamoto’s guitarist](https://sivers.org/sakamoto)
...
- ​	1997: started [CD Baby](https://www.cdbaby.com/)
...
- ​	2007: [rough year](https://sivers.org/loss), moved to London, decided to quit my company
- ​	2008: moved to San Francisco, [sold CD Baby and HostBaby](https://sivers.org/done)
- ​	2009: moved to New York City, started [writing](https://sivers.org/blog) and [speaking](https://sivers.org/presentations) more
- ​	2010: [spoke at TED](https://www.ted.com/speakers/derek_sivers) three times in a year, moved to Singapore
- ​	2011: published “[Anything You Want](https://sivers.org/a)” book about my CD Baby days, started [Wood Egg](https://woodegg.com/)
- ​	2012: had a baby
- ​	2013: moved to New Zealand to [raise him in nature](https://sivers.org/pa) and be a mostly-full-time dad
- ​	2014 to 2018: sabbatical, but [answered 92,354 emails from 33,776 people](https://sivers.org/faq)
...
​	I was single-focused obsessed with being a successful musician from age 14 to 29 — crucial years when many of my friends were feeling lost. It had me waking up early to practice, staying up late to write, saying no to all distractions, and reading whatever I could to improve. Then, at age 29, I [accidentally started a company](https://sivers.org/a), so I was narrow-focused on creating that for 10 years, through the age of 39.
...
​	I’ve always had an uncommon approach to life, mostly shaped by my ambition. But when I read [a book on Stoicism](https://sivers.org/book/StoicJoy) I realized I wasn’t so unique. My own self-created philosophy lined up almost exactly with this ancient philosophy. So, if you want to know my approach to life, [go read these book notes](https://sivers.org/book/StoicJoy). Especially the biggest point about strengthening yourself for a more difficult future.

​	But I’m also very skeptical, and was surprised to find [that’s also a philosophy](https://en.wikipedia.org/wiki/Skepticism). Meaning: **for almost anything on this page, the [opposite may also be true](https://sivers.org/opposite).  I don’t trust what I tell myself.** It’s not a lie — it’s my truth at the time. But an opposite point of view can replace it when I shift my perspective. (I sometimes do this intentionally: do the opposite of my beliefs, just for a different perspective.)
...
​	Two of my best friends right now, I’ve never seen in-person. One lives in Hong Kong. One lives in Lithuania. We’ve been talking on the phone for years, but never met in-person. We don’t even video-chat. Just voice. That’s all I need. (Because of this, I loved the movie “[Her](https://www.imdb.com/title/tt1798709/)”.)
...
​	My main tools are the [Vim](https://www.vim.org/) text editor, [OpenBSD](https://sivers.org/openbsd) operating system, [PostgreSQL](https://sivers.org/pg) database, [Ruby](https://www.ruby-lang.org/en/) language, and [Firefox](https://www.mozilla.org/) browser.
...
- ​	**Song craft.** 	I admire it like a carpenter admires a well-made table. I worked hard for [15 years](https://sivers.org/music) to write the best songs I could, trying to learn everything about that craft, and so appreciate a good one.
...
- ​	**I like women.** 	Almost all of my best friends are women. [Gender stereotypes](https://sivers.org/mw) bristle me.
...
- ​	**I care deeply about very little.** 	I’m committed to just a few people and a few interests. Everything else, I keep away. (See “[hell yeah or no](https://sivers.org/hellyeah)”.) It’s a simple and sincere life.
